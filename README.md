...
- `ALLOW_REMOTE_DASHBOARD`, `STRICT_LIVE_QUOTA`
...
- `CLAUDE_CODE_OAUTH_CLIENT_ID`, `CLAUDE_CODE_OAUTH_CLIENT_SECRET`, `CLAUDE_CODE_OAUTH_AUTHORIZATION_URL`, `CLAUDE_CODE_OAUTH_TOKEN_URL`, `CLAUDE_CODE_OAUTH_USERINFO_URL`, `CLAUDE_CODE_OAUTH_SCOPES`
